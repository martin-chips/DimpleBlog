      ...
      <div class="createPost-main-container">
        <el-row>
          <el-col :span="24">
            ...
            <el-form-item prop="title">
              <MDinput v-model="postForm.content_short" :maxlength="150" name="name" required>
                摘要
              </MDinput>
        ...
        <el-form-item prop="image_uri" style="margin-bottom: 30px;" label-width="120px" label="发布时间"
...
<script>
  ...
  export default {
    name: 'ArticleDetail',
    components: {CommentDropdown, CategoryDropdown, MDinput, Tinymce, Sticky, Upload},
    props: {
      isEdit: {
        type: Boolean,
        default: false
