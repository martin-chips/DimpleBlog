...
import com.dimple.annotation.rest.AnonymousDeleteMapping;
import com.dimple.annotation.rest.AnonymousGetMapping;
import com.dimple.annotation.rest.AnonymousPostMapping;
...
import com.dimple.modules.security.security.TokenProvider;
...
public class AuthorizationController {
    ...
    public ResponseEntity<Object> login(@Validated @RequestBody AuthUserDTO authUser, HttpServletRequest request) throws Exception {
        ...
        if (StringUtils.isBlank(code)) {
            loginLogService.save(false, authUser.getUsername(), authUser.getUuid(), request, "验证码不存在或已过期");
            throw new BadRequestException("验证码不存在或已过期");
        }
        if (StringUtils.isBlank(authUser.getCode()) || !authUser.getCode().equalsIgnoreCase(code)) {
            loginLogService.save(false, authUser.getUsername(), authUser.getUuid(), request, "验证码错误");
        ...
        try {
            ...
            loginLogService.save(false, authUser.getUsername(), authUser.getUuid(), request, e.getMessage());
            throw e;
        }
        ...
        loginLogService.save(true, authUser.getUsername(), authUser.getUuid(), request, "登录成功");
