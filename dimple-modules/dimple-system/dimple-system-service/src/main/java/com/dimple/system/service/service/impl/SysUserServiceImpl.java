...
import com.dimple.common.core.utils.bean.BeanValidators;
...
public class SysUserServiceImpl implements SysUserService {
    ...
    public List<SysUserBO> selectUserList(SysUserBO user) {
        SysUser sysUser = BeanMapper.convert(user, SysUser.class);
        return BeanMapper.convertList(userMapper.selectUserList(sysUser), SysUserBO.class);
    }
    ...
    @Override
    @DataScope(userAlias = "u")
    public List<SysUserBO> selectAllocatedList(SysUserBO user) {
        SysUser sysUser = BeanMapper.convert(user, SysUser.class);
        return BeanMapper.convertList(userMapper.selectAllocatedList(sysUser), SysUserBO.class);
    }
    ...
    @Override
    @DataScope(userAlias = "u")
    public List<SysUserBO> selectUnallocatedList(SysUserBO user) {
        SysUser sysUser = BeanMapper.convert(user, SysUser.class);
        return BeanMapper.convertList(userMapper.selectUnallocatedList(sysUser), SysUserBO.class);
    }
    ...
    public SysUserBO selectUserByUserName(String userName) {
        ...
        return BeanMapper.convert(userMapper.selectUserByUserName(userName), SysUserBO.class);
    }
     ...
     */
    @Override
    public SysUserBO selectUserById(Long userId) {
        return BeanMapper.convert(userMapper.selectUserById(userId), SysUserBO.class);
    }
    ...
    public void checkUserDataScope(Long userId) {
        if (!SysUser.isAdmin(SecurityUtils.getUserId())) {
            ...
            List<SysUserBO> users = SpringUtils.getAopProxy(this).selectUserList(user);
    ...
    public boolean registerUser(SysUserBO user) {
        return userMapper.insertUser(BeanMapper.convert(user, SysUser.class)) > 0;
    }
    ...
    public int updateUser(SysUserBO user) {
        ...
        // 新增用户与角色管理
        insertUserRole(user);
        return userMapper.updateUser(BeanMapper.convert(user, SysUser.class));
    }
