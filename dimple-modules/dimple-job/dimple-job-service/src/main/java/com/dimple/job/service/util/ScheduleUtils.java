...
import com.dimple.common.core.exception.job.TaskException.Code;
...
public class ScheduleUtils {
     ...
     * @return 具体执行任务类
     */
    private static Class<? extends Job> getQuartzJobClass(SysJobBO sysJob) {
     ...
     * 设置定时任务策略
     */
    public static CronScheduleBuilder handleCronScheduleMisfirePolicy(SysJobBO job, CronScheduleBuilder cb)
