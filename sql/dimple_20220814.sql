...
values (1, '系统管理', 0, 1, 'system', null, '', 1, 0, 'M', '0', '0', '', 'system', 'admin', '系统管理目录'),
       ...
       (4, 'Dimple官网', 0, 10, 'http://bianxf.com', null, '', 0, 0, 'M', '0', '0', '', 'guide', 'admin',
        'Dimple官网地址'),
       ...
       (107, '通知公告', 1, 8, 'notice', 'system/notice/index', '', 1, 0, 'C', '0', '0', 'system:notice:list',
        'message', 'admin', '通知公告菜单'),
       (108, 'Redis监控', 2, 1, 'redis', 'monitor/redis/index', '', 1, 0, 'C', '0', '0', 'monitor:redis:list',
        'online', 'admin', 'Redis监控菜单'),
       (109, '在线用户', 2, 1, 'online', 'monitor/online/index', '', 1, 0, 'C', '0', '0', 'monitor:online:list',
        'online', 'admin', '在线用户菜单'),
       (111, 'Sentinel控制台', 2, 3, 'http://localhost:8718', '', '', 0, 0, 'C', '0', '0', 'monitor:sentinel:list',
        'sentinel', 'admin', '流量控制菜单'),
       (112, 'Nacos控制台', 2, 4, 'http://localhost:8848/nacos', '', '', 0, 0, 'C', '0', '0', 'monitor:nacos:list',
        'nacos', 'admin', '服务治理菜单'),
       (113, 'Admin控制台', 2, 5, 'http://localhost:9100/login', '', '', 0, 0, 'C', '0', '0', 'monitor:server:list',
        'server', 'admin', '服务监控菜单'),
       (110, '定时任务', 3, 2, 'job', 'monitor/job/index', '', 1, 0, 'C', '0', '0', 'monitor:job:list', 'job', 'admin',
        '定时任务菜单'),
       ...
       (115, '代码生成', 3, 2, 'gen', 'tool/gen/index', '', 1, 0, 'C', '0', '0', 'tool:gen:list', 'code', 'admin',
        '代码生成菜单'),
       (116, '系统接口', 3, 3, 'http://localhost:8080/swagger-ui/index.html', '', '', 0, 0, 'C', '0', '0',
        'tool:swagger:list', 'swagger', 'admin', '系统接口菜单'),
       ...
       (5021, '登录查询', 502, 1, '#', '', '', 1, 0, 'F', '0', '0', 'log:logininfor:query', '#', 'admin', ''),
       (5022, '登录删除', 502, 2, '#', '', '', 1, 0, 'F', '0', '0', 'log:logininfor:remove', '#', 'admin', ''),
       (5023, '日志导出', 502, 3, '#', '', '', 1, 0, 'F', '0', '0', 'log:logininfor:export', '#', 'admin', ''),
...
values (30, 3, '固定超时', '3', 'redis_timeout_type', null, 'default', 'N', '0', 'admin', sysdate(), '', null, null),
       ...
       (38, 0, '查看归档', 'LIST_ARCHIVES', 'blog_log_title', null, 'success', 'N', '0', 'admin', sysdate(), '', null, null),
       (39, 0, '首页', 'LIST_ARTICLE', 'blog_log_title', null, 'success', 'N', '0', 'admin', sysdate(), '', null, null),
       (40, 0, '查看文章', 'GET_ARTICLE', 'blog_log_title', null, 'success', 'N', '0', 'admin', sysdate(), '', null, null),
       (41, 0, '点赞文章', 'LIKE_ARTICLE', 'blog_log_title', null, 'success', 'N', '0', 'admin', sysdate(), '', null, null),
       (42, 0, '查看分类', 'LIST_CATEGORY', 'blog_log_title', null, 'success', 'N', '0', 'admin', sysdate(), '', null, null),
       (43, 0, '查看文章评论', 'LIST_COMMENT', 'blog_log_title', null, 'success', 'N', '0', 'admin', sysdate(), '', null, null),
       (44, 0, '新增文章评论', 'ADD_COMMENT', 'blog_log_title', null, 'success', 'N', '0', 'admin', sysdate(), '', null, null),
       (45, 0, '点赞博客评论', 'LIKE_COMMENT', 'blog_log_title', null, 'success', 'N', '0', 'admin', sysdate(), '', null, null),
       (46, 0, '查看友链', 'LIST_LINK', 'blog_log_title', null, 'success', 'N', '0', 'admin', sysdate(), '', null, null),
       (47, 0, '申请友链', 'ADD_LINK', 'blog_log_title', null, 'success', 'N', '0', 'admin', sysdate(), '', null, null),
       (48, 0, '访问友链', 'VISIT_LINK', 'blog_log_title', null, 'success', 'N', '0', 'admin', sysdate(), '', null, null),
       (49, 0, '查看留言板', 'LIST_MESSAGE_BOARD', 'blog_log_title', null, 'success', 'N', '0', 'admin', sysdate(), '', null, null),
       (50, 0, '新增留言板留言', 'ADD_MESSAGE_BOARD', 'blog_log_title', null, 'success', 'N', '0', 'admin', sysdate(), '', null, null),
       (51, 0, '点赞留言板留言', 'LIKE_MESSAGE_BOARD', 'blog_log_title', null, 'success', 'N', '0', 'admin', sysdate(), '', null, null),
       (52, 0, '查看标签', 'LIST_TAG', 'blog_log_title', null, 'success', 'N', '0', 'admin', sysdate(), '', null, null),
       (53, 0, '查看关于我', 'LIST_ABOUT', 'blog_log_title', null, 'success', 'N', '0', 'admin', sysdate(), '', null, null),
       (54, 0, 'Github登录', 'GITHUB_LOGIN', 'blog_log_title', null, 'success', 'N', '0', 'admin', sysdate(), '', null, null),
