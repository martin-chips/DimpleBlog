...
values (1, '系统管理', 0, 800, 'system', null, '', 1, 0, 'M', '0', '0', '', 'system', 'admin', sysdate(), 'admin', null,
        '系统管理目录'),
       (2, '系统监控', 0, 500, 'monitor', null, '', 1, 0, 'M', '0', '0', '', 'monitor', 'admin', sysdate(), 'admin',
        null, '系统监控目录'),
       (3, '系统工具', 0, 900, 'tool', null, '', 1, 0, 'M', '0', '0', '', 'tool', 'admin', sysdate(), 'admin', null,
        '系统工具目录'),
       (4, 'Dimple官网', 0, 1000, 'http://bianxf.com', null, '', 0, 0, 'M', '0', '0', '', 'guide', 'admin', sysdate(),
        'admin', null, 'Dimple官网地址'),
       (5, '日志管理', 0, 600, 'log', '', '', 1, 0, 'M', '0', '0', '', 'log', 'admin', sysdate(), 'admin', null,
        '日志管理菜单'),
       (6, '博客管理', 0, 100, 'blog', '', '', 1, 0, 'M', '0', '0', '', 'post', 'admin', sysdate(), 'admin', null,
        'Blog管理菜单'),
       ...
       (108, 'Redis监控', 2, 1, 'redis', 'monitor/redis/index', '', 1, 0, 'C', '0', '0', 'monitor:redis:list', 'online',
        'admin', sysdate(), '', null, 'Redis监控菜单'),
       (109, '在线用户', 2, 1, 'online', 'monitor/online/index', '', 1, 0, 'C', '0', '0', 'monitor:online:list',
        'online', 'admin', sysdate(), '', null, '在线用户菜单'),
       (110, '定时任务', 3, 2, 'job', 'tool/job/index', '', 1, 0, 'C', '0', '0', 'tool:job:list', 'job', 'admin',
        sysdate(), '', null, '定时任务菜单'),
       (111, 'Sentinel控制台', 2, 3, 'http://www.bianxf.com::8718', '', '', 0, 0, 'C', '0', '0',
        'monitor:sentinel:list', 'sentinel', 'admin', sysdate(), '', null, '流量控制菜单'),
       (112, 'Nacos控制台', 2, 4, 'http://www.bianxf.com:8848/nacos/', '', '', 0, 0, 'C', '0', '0',
        'monitor:nacos:list', 'nacos', 'admin', sysdate(), '', null, '服务治理菜单'),
       (113, 'Admin控制台', 2, 5, 'http://www.bianxf.com:9100/login', '', '', 0, 0, 'C', '0', '0',
        'monitor:server:list', 'server', 'admin', sysdate(), '', null, '服务监控菜单'),
       (116, '系统接口', 3, 3, 'http://www.bianxf.com:8080/swagger-ui/index.html', '', '', 0, 0, 'C', '0', '0',
        'tool:swagger:list', 'swagger', 'admin', sysdate(), '', null, '系统接口菜单'),
       (500, '操作日志', 5, 1, 'operlog', 'log/operlog/index', '', 1, 0, 'C', '0', '0', 'log:operlog:list', 'form',
        'admin', sysdate(), '', null, '操作日志菜单'),
       (501, '登录日志', 5, 2, 'logininfor', 'log/logininfor/index', '', 1, 0, 'C', '0', '0', 'log:logininfor:list',
        'logininfor', 'admin', sysdate(), '', null, '登录日志菜单'),
       (502, '访问日志', 5, 2, 'visitlog', 'log/visitlog/index', '', 1, 0, 'C', '0', '0', 'log:visitlog:list',
        'eye-open', 'admin', sysdate(), '', null, '访问日志菜单'),
       (503, '任务日志', 5, 3, 'joblog', 'log/joblog/index', '', 1, 0, 'C', '0', '0', 'log:joblog:list', 'skill',
        'admin', sysdate(), '', null, '任务日志菜单'),
       ...
       (602, '分类管理', 6, 1, 'category', 'blog/category/index', null, 1, 0, 'C', '0', '0', 'blog:category:list',
        'skill', 'admin', sysdate(), '', null, '分类菜单'),
       (603, '评论管理', 6, 1, 'comment', 'blog/comment/index', null, 1, 0, 'C', '0', '0', 'blog:comment:list',
        'message', 'admin', sysdate(), '', null, '评论菜单'),
       (604, '标签管理', 6, 1, 'tag', 'blog/tag/index', null, 1, 0, 'C', '0', '0', 'blog:tag:list', 'row', 'admin',
        sysdate(), '', null, '标签菜单'),
       (605, '友链管理', 6, 1, 'link', 'blog/link/index', null, 1, 0, 'C', '0', '0', 'blog:link:list', 'peoples',
        'admin', sysdate(), '', null, '友链菜单'),
       (606, '关于我管理', 6, 1, 'about', 'blog/about/index', null, 1, 0, 'C', '0', '0', 'blog:about:query', 'people',
        'admin', sysdate(), '', null, '关于我菜单'),
       (607, '站点管理', 6, 1, 'config', 'blog/config/index', null, 1, 0, 'C', '0', '0', 'blog:config:query', 'server',
        'admin', sysdate(), '', null, '博客配置菜单'),
       (1000, '用户查询', 100, 1, '', '', '', 1, 0, 'F', '0', '0', 'system:user:query', '#', 'admin', sysdate(), '',
        null, ''),
       ...
       (1006, '重置密码', 100, 7, '', '', '', 1, 0, 'F', '0', '0', 'system:user:resetPwd', '#', 'admin', sysdate(), '',
        null, ''),
       (1007, '角色查询', 101, 1, '', '', '', 1, 0, 'F', '0', '0', 'system:role:query', '#', 'admin', sysdate(), '',
        null, ''),
       ...
       (1011, '角色导出', 101, 5, '', '', '', 1, 0, 'F', '0', '0', 'system:role:export', '#', 'admin', sysdate(), '',
        null, ''),
       (1012, '菜单查询', 102, 1, '', '', '', 1, 0, 'F', '0', '0', 'system:menu:query', '#', 'admin', sysdate(), '',
        null, ''),
       ...
       (1015, '菜单删除', 102, 4, '', '', '', 1, 0, 'F', '0', '0', 'system:menu:remove', '#', 'admin', sysdate(), '',
        null, ''),
       (1025, '字典查询', 105, 1, '#', '', '', 1, 0, 'F', '0', '0', 'system:dict:query', '#', 'admin', sysdate(), '',
        null, ''),
       ...
       (1029, '字典导出', 105, 5, '#', '', '', 1, 0, 'F', '0', '0', 'system:dict:export', '#', 'admin', sysdate(), '',
        null, ''),
       (1030, '参数查询', 106, 1, '#', '', '', 1, 0, 'F', '0', '0', 'system:config:query', '#', 'admin', sysdate(), '',
        null, ''),
       ...
       (1034, '参数导出', 106, 5, '#', '', '', 1, 0, 'F', '0', '0', 'system:config:export', '#', 'admin', sysdate(), '',
        null, ''),
       (1035, '公告查询', 107, 1, '#', '', '', 1, 0, 'F', '0', '0', 'system:notice:query', '#', 'admin', sysdate(), '',
        null, ''),
       ...
       (1038, '公告删除', 107, 4, '#', '', '', 1, 0, 'F', '0', '0', 'system:notice:remove', '#', 'admin', sysdate(), '',
        null, ''),
       (1039, '操作查询', 500, 1, '#', '', '', 1, 0, 'F', '0', '0', 'log:operlog:query', '#', 'admin', sysdate(), '',
        null, ''),
       (1040, '操作删除', 500, 2, '#', '', '', 1, 0, 'F', '0', '0', 'log:operlog:remove', '#', 'admin', sysdate(), '',
        null, ''),
       (1041, '日志导出', 500, 3, '#', '', '', 1, 0, 'F', '0', '0', 'log:operlog:export', '#', 'admin', sysdate(), '',
        null, ''),
       (1042, '登录查询', 501, 1, '#', '', '', 1, 0, 'F', '0', '0', 'log:logininfor:query', '#', 'admin', sysdate(), '',
        null, ''),
       (1043, '登录删除', 501, 2, '#', '', '', 1, 0, 'F', '0', '0', 'log:logininfor:remove', '#', 'admin', sysdate(),
        '', null, ''),
       (1044, '日志导出', 501, 3, '#', '', '', 1, 0, 'F', '0', '0', 'log:logininfor:export', '#', 'admin', sysdate(),
        '', null, ''),
       (1045, '账户解锁', 501, 4, '#', '', '', 1, 0, 'F', '0', '0', 'system:user:unlock', '#', 'admin', sysdate(), '',
        null, ''),
       (1046, '在线查询', 109, 1, '#', '', '', 1, 0, 'F', '0', '0', 'monitor:online:query', '#', 'admin', sysdate(), '',
        null, ''),
       (1047, '批量强退', 109, 2, '#', '', '', 1, 0, 'F', '0', '0', 'monitor:online:batchLogout', '#', 'admin',
        sysdate(), '', null, ''),
       (1048, '单条强退', 109, 3, '#', '', '', 1, 0, 'F', '0', '0', 'monitor:online:forceLogout', '#', 'admin',
        sysdate(), '', null, ''),
       (1081, 'RedisKey删除', 108, 3, '#', '', '', 1, 0, 'F', '0', '0', 'mmonitor:redis:remove', '#', 'admin',
        sysdate(), '', null, ''),
       (1082, 'RedisKey查询', 108, 3, '#', '', '', 1, 0, 'F', '0', '0', 'monitor:redis:query', '#', 'admin', sysdate(),
        '', null, ''),
       ...
       (1051, '任务修改', 110, 3, '#', '', '', 1, 0, 'F', '0', '0', 'tool:job:edit', '#', 'admin', sysdate(), '', null,
        ''),
       (1052, '任务删除', 110, 4, '#', '', '', 1, 0, 'F', '0', '0', 'tool:job:remove', '#', 'admin', sysdate(), '',
        null, ''),
       (1053, '状态修改', 110, 5, '#', '', '', 1, 0, 'F', '0', '0', 'tool:job:changeStatus', '#', 'admin', sysdate(),
        '', null, ''),
       (1054, '任务导出', 110, 6, '#', '', '', 1, 0, 'F', '0', '0', 'tool:job:export', '#', 'admin', sysdate(), '',
        null, ''),
       (2000, '文章查询', 601, 1, '#', '', null, 1, 0, 'F', '0', '0', 'blog:article:query', '#', 'admin', sysdate(), '',
        null, ''),
       (2001, '文章新增', 601, 2, '#', '', null, 1, 0, 'F', '0', '0', 'blog:article:add', '#', 'admin', sysdate(), '',
        null, ''),
       (2002, '文章修改', 601, 3, '#', '', null, 1, 0, 'F', '0', '0', 'blog:article:edit', '#', 'admin', sysdate(), '',
        null, ''),
       (2003, '文章删除', 601, 4, '#', '', null, 1, 0, 'F', '0', '0', 'blog:article:remove', '#', 'admin', sysdate(),
        '', null, ''),
       (2004, '文章导出', 601, 5, '#', '', null, 1, 0, 'F', '0', '0', 'blog:article:export', '#', 'admin', sysdate(),
        '', null, ''),
       (2005, '分类查询', 602, 1, '#', '', null, 1, 0, 'F', '0', '0', 'blog:category:query', '#', 'admin', sysdate(),
        '', null, ''),
       (2006, '分类新增', 602, 2, '#', '', null, 1, 0, 'F', '0', '0', 'blog:category:add', '#', 'admin', sysdate(), '',
        null, ''),
       (2007, '分类修改', 602, 3, '#', '', null, 1, 0, 'F', '0', '0', 'blog:category:edit', '#', 'admin', sysdate(), '',
        null, ''),
       (2008, '分类删除', 602, 4, '#', '', null, 1, 0, 'F', '0', '0', 'blog:category:remove', '#', 'admin', sysdate(),
        '', null, ''),
       (2009, '分类导出', 602, 5, '#', '', null, 1, 0, 'F', '0', '0', 'blog:category:export', '#', 'admin', sysdate(),
        '', null, ''),
       (2010, '评论查询', 603, 1, '#', '', null, 1, 0, 'F', '0', '0', 'blog:comment:query', '#', 'admin', sysdate(), '',
        null, ''),
       (2011, '评论修改', 603, 3, '#', '', null, 1, 0, 'F', '0', '0', 'blog:comment:edit', '#', 'admin', sysdate(), '',
        null, ''),
       (2012, '评论删除', 603, 4, '#', '', null, 1, 0, 'F', '0', '0', 'blog:comment:remove', '#', 'admin', sysdate(),
        '', null, ''),
       (2013, '评论导出', 603, 5, '#', '', null, 1, 0, 'F', '0', '0', 'blog:comment:export', '#', 'admin', sysdate(),
        '', null, ''),
       (2014, '标签查询', 604, 1, '#', '', null, 1, 0, 'F', '0', '0', 'blog:tag:query', '#', 'admin', sysdate(), '',
        null, ''),
       (2015, '标签新增', 604, 2, '#', '', null, 1, 0, 'F', '0', '0', 'blog:tag:add', '#', 'admin', sysdate(), '', null,
        ''),
       (2016, '标签修改', 604, 3, '#', '', null, 1, 0, 'F', '0', '0', 'blog:tag:edit', '#', 'admin', sysdate(), '',
        null, ''),
       (2017, '标签删除', 604, 4, '#', '', null, 1, 0, 'F', '0', '0', 'blog:tag:remove', '#', 'admin', sysdate(), '',
        null, ''),
       (2018, '标签导出', 604, 5, '#', '', null, 1, 0, 'F', '0', '0', 'blog:tag:export', '#', 'admin', sysdate(), '',
        null, ''),
       (2019, '友链查询', 605, 1, '#', '', null, 1, 0, 'F', '0', '0', 'blog:link:query', '#', 'admin', sysdate(), '',
        null, ''),
       (2020, '友链新增', 605, 2, '#', '', null, 1, 0, 'F', '0', '0', 'blog:link:add', '#', 'admin', sysdate(), '',
        null, ''),
       (2021, '友链修改', 605, 3, '#', '', null, 1, 0, 'F', '0', '0', 'blog:link:edit', '#', 'admin', sysdate(), '',
        null, ''),
       (2022, '友链删除', 605, 4, '#', '', null, 1, 0, 'F', '0', '0', 'blog:link:remove', '#', 'admin', sysdate(), '',
        null, ''),
       (2023, '友链导出', 605, 5, '#', '', null, 1, 0, 'F', '0', '0', 'blog:link:export', '#', 'admin', sysdate(), '',
        null, ''),
       (2024, '关于我查询', 606, 3, '#', '', null, 1, 0, 'F', '0', '0', 'blog:about:query', '#', 'admin', sysdate(), '',
        null, ''),
       (2025, '关于我修改', 606, 3, '#', '', null, 1, 0, 'F', '0', '0', 'blog:about:edit', '#', 'admin', sysdate(), '',
        null, ''),
       (2026, '站点配置编辑', 607, 3, '#', '', null, 1, 0, 'F', '0', '0', 'blog:config:edit', '#', 'admin', sysdate(),
        '', null, ''),
       (2027, '站点配置查询', 607, 3, '#', '', null, 1, 0, 'F', '0', '0', 'blog:config:query', '#', 'admin', sysdate(),
        '', null, ''),
       (2028, '站点配置缓存删除', 607, 3, '#', '', null, 1, 0, 'F', '0', '0', 'blog:config:remove', '#', 'admin',
        sysdate(), '', null, ''),
       (5021, '登录查询', 502, 1, '#', '', '', 1, 0, 'F', '0', '0', 'log:logininfor:query', '#', 'admin', sysdate(), '',
        null, ''),
       (5022, '登录删除', 502, 2, '#', '', '', 1, 0, 'F', '0', '0', 'log:logininfor:remove', '#', 'admin', sysdate(),
        '', null, ''),
       (5023, '日志导出', 502, 3, '#', '', '', 1, 0, 'F', '0', '0', 'log:logininfor:export', '#', 'admin', sysdate(),
        '', null, ''),
       (5031, '日志查询', 503, 1, '#', '', '', 1, 0, 'F', '0', '0', 'log:joblog:query', '#', 'admin', sysdate(), '',
        null, ''),
       (5032, '登录删除', 503, 2, '#', '', '', 1, 0, 'F', '0', '0', 'log:joblog:remove', '#', 'admin', sysdate(), '',
        null, ''),
       (5033, '日志导出', 503, 3, '#', '', '', 1, 0, 'F', '0', '0', 'log:joblog:export', '#', 'admin', sysdate(), '',
        null, '');
...
insert into sys_dict_type (id, dict_name, dict_type, status, create_by, create_time, update_by, update_time,
                           remark)
...
insert into sys_dict_data (id, dict_sort, dict_label, dict_value, dict_type, css_class, list_class, is_default,
...
insert into sys_config (id, config_name, config_key, config_value, config_type, create_by, create_time, update_by,
                        update_time, remark)
values (5, '管理系统全局-灰色遮罩', 'sys.index.mask', 'false', 'Y', 'admin', '2023-03-26 12:25:45', 'admin',
        '2023-03-27 20:31:57', 'true 表示开启，false表示关闭');
...
values ('1', '温馨提醒：2018-07-01 Dimple新版本发布啦', '1', '2', '新版本内容', '0', 'admin', sysdate(), '', null,
        '管理员');
insert into sys_notice
values ('2', '维护通知：2018-07-01 Dimple系统凌晨维护', '1', '1', '维护内容', '0', 'admin', sysdate(), '', null,
        '管理员');
