/*
 ...
 Source Schema         : dimpleblog

 Target Server Type    : MySQL
 Target Server Version : 80020
 File Encoding         : 65001

 Date: 23/06/2020 16:02:25
*/
...
CREATE TABLE `bg_blog`  (
  `blog_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT ' id',
  ...
  `header_img_type` int(0) NOT NULL,
  `header_img` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT ' 封面图片地址 ',
  `html_content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  `content` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT ' 正文内容 ',
  `status` tinyint(0) NULL DEFAULT NULL COMMENT ' 文章状态,\n    1表示已经发表,\n    2表示草稿箱 ',
  `comment` tinyint(0) NULL DEFAULT NULL COMMENT ' 是否允许评论,\n    1表示允许,\n    0表示不允许 ',
  `support` tinyint(0) NULL DEFAULT 0 COMMENT ' 推荐 ',
  `weight` bigint(0) NULL DEFAULT 1 COMMENT ' 权重 ',
  `like` bigint(0) NULL DEFAULT 0 COMMENT ' 点赞数 ',
  `click` bigint(0) NULL DEFAULT 0 COMMENT ' 点击数 ',
  `create_by` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `update_by` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `update_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`blog_id`) USING BTREE,
  INDEX `blog_id_support_status_index`(`blog_id`, `support`, `status`) USING BTREE
...
CREATE TABLE `bg_category`  (
  ...
  `support` tinyint(0) NULL DEFAULT NULL COMMENT '是否推荐',
  `create_by` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `update_by` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `update_time` datetime(0) NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `bg_category` VALUES (1, 'Java基础', 'Java基础知识,记录开发过程中遇到的问题', 1, '1', NULL, NULL, NULL);
INSERT INTO `bg_category` VALUES (2, '闲言碎语', '记录个人生活感悟,感想', 1, '1', NULL, NULL, NULL);
INSERT INTO `bg_category` VALUES (3, 'MySQL', '记录MySQL使用过程中遇到的一些问题', 1, '1', NULL, NULL, NULL);
INSERT INTO `bg_category` VALUES (4, 'SpringBoot', '记录SpringBoot使用过程中遇到的一些问题', 1, '1', NULL, NULL, NULL);
INSERT INTO `bg_category` VALUES (5, 'Docker', '记录Docker容器学习记录', 1, '1', NULL, NULL, NULL);
INSERT INTO `bg_category` VALUES (6, 'Hexo博客', 'Hexo博客搭建和设置', 1, '1', NULL, NULL, NULL);
INSERT INTO `bg_category` VALUES (7, '大学期间资料', '记录本人大学期间的一些学习资料', 1, '1', NULL, NULL, NULL);
INSERT INTO `bg_category` VALUES (8, 'Android', '记录Android开发过程中的学习笔记', 1, '1', NULL, NULL, NULL);
INSERT INTO `bg_category` VALUES (9, 'SpringCloud', '记录SpringCloud学习记录', 1, '1', NULL, NULL, NULL);
INSERT INTO `bg_category` VALUES (10, '开发工具', '记录开发工具的配置和使用', 1, '1', NULL, NULL, NULL);
INSERT INTO `bg_category` VALUES (11, 'JavaEE', NULL, NULL, '1', NULL, NULL, NULL);
...
CREATE TABLE `bg_comment`  (
  ...
  `request_ip` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'IP地址',
  ...
  `parent_id` bigint(0) NULL DEFAULT NULL COMMENT '父评论的id',
  ...
  `page_id` bigint(0) NULL DEFAULT NULL COMMENT '页面ID',
  `request_url` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '页面的URL',
  `display` tinyint(0) NULL DEFAULT NULL COMMENT '1表示显示,0表示不显示',
  `good` bigint(0) NULL DEFAULT 0 COMMENT '点赞',
  `bad` bigint(0) NULL DEFAULT 0 COMMENT '踩',
  ...
  `reply` tinyint(0) NULL DEFAULT NULL,
  `admin_reply` tinyint(0) NULL DEFAULT NULL,
...
CREATE TABLE `bg_tag`  (
  `tag_id` bigint(0) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sys_login_log`  (
  `login_log_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '访问ID',
  `user_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '用户账号',
  `request_ip` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '登录IP地址',
  `address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '登录地点',
  `browser` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '浏览器类型',
  `os` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '操作系统',
  `status` tinyint(0) NULL DEFAULT 0 COMMENT '登录状态（1成功 0失败）',
...
CREATE TABLE `sys_operate_log`  (
  `operate_log_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'ID',
...
) ENGINE = InnoDB AUTO_INCREMENT = 153 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统日志' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_visit_log`  (
  `visit_log_id` bigint(0) NOT NULL AUTO_INCREMENT,
  `request_ip` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT 'IP地址',
  `page_id` bigint(0) NULL DEFAULT NULL COMMENT '页面ID',
  `address` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '地理位置',
  `browser` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '浏览器',
  `os` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '操作系统',
  `entry_url` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `url` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '访问URL地址',
  `exception_detail` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `status` tinyint(0) NULL DEFAULT NULL COMMENT '状态,1表示成功,0表示失败',
  `title` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '访问模块',
  `spider` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '爬虫',
  `create_time` datetime(0) NULL DEFAULT NULL,
  `delete_time` datetime(0) NULL DEFAULT NULL,
  `create_by` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `delete_by` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `time` bigint(0) NULL DEFAULT NULL COMMENT '请求耗时',
...
CREATE TABLE `tool_picture`  (
  `picture_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'ID',
