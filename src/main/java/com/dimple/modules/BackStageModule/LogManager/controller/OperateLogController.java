...
public class OperateLogController {
    ...
    @RequiresPermissions("page:operatorLog:view")
    @ApiIgnore
    ...
    @RequiresPermissions("page:operatorLogDetail:view")
    @ApiIgnore
    ...
    @ResponseBody
    @RequiresPermissions("logManager:operator:query")
    ...
    @RequiresPermissions("logManager:operator:delete")
