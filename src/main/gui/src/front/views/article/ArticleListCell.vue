        ...
        <div class="text-wrapper">
          ...
          <div class="tags">
            <a v-for="tag in article.tagList">
              <el-tag effect="plain" :key="tag.id" class="border-tag" size="small"
                      :style="{borderColor:tag.color,color:tag.color} " :hit="true" style="margin: 2px 4px 2px 0">
                {{tag.title}}
              </el-tag>
            </a>
          </div>
          ...
          <p class="operate_info">
            ...
            <span class="likes">
              <a @click="likePost(article)"><svg-icon icon-class="like" /> {{article.like}} 赞</a>
            </span>
          </p>
        </div>
      </el-col>
