            ...
            <Col :xs="24" :sm="24" :md="textSpan" :lg="textSpan" :order="textOrderType"
                ...
                <div class="text-wrapper">
                    ...
                    <p class="operate_info">
                        ...
                        <span class="readings">
              <a><Icon type="ios-eye"/> {{article.click}} 阅读</a>
            </span>
                        <span class="comments">
              <a><Icon type="ios-create"></Icon> {{article.commentCount}} 评论</a>
            </span>
                        <span class="likes">
              <a @click="likePost(article)"><Icon type="ios-heart"/> {{article.like}} 赞</a>
            </span>
                    </p>
                </div>
            </Col>
