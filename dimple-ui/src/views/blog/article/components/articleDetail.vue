  ...
  <div class="createPost-container">
    <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container">
      ...
      <sticky :z-index="10" :class-name="'sub-navbar '+postForm.status">
        ...
        <OrginalDropdown v-model="postForm.orginal"/>
...
import {CommentDropdown, orginalDropdown} from './dropdown'
...
export default {
  name: 'ArticleDetail',
  components: {Tinymce, MDinput, Upload, Sticky, CommentDropdown, orginalDropdown},
  props: {
    isEdit: {
      type: Boolean,
      default: false
